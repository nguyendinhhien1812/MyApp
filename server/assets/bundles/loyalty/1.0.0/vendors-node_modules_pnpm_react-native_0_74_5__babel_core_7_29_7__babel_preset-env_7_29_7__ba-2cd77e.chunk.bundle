(self["webpackChunkloyalty"] = self["webpackChunkloyalty"] || []).push([["vendors-node_modules_pnpm_react-native_0_74_5__babel_core_7_29_7__babel_preset-env_7_29_7__ba-2cd77e"], {
29087: (function (__unused_rspack_module, exports, __webpack_require__) {
...
function renderElement(param) {
    ...
    if (useFabric) {
        (__webpack_require__(83644)/* .render */.render)(element, rootTag, null, useConcurrentRoot);
    } else {
        (__webpack_require__(49098)/* .render */.render)(element, rootTag);
    }
}
function findHostInstance_DEPRECATED(componentOrHandle) {
    return (__webpack_require__(49098)/* .findHostInstance_DEPRECATED */.findHostInstance_DEPRECATED)(componentOrHandle);
}
function findNodeHandle(componentOrHandle) {
    return (__webpack_require__(49098)/* .findNodeHandle */.findNodeHandle)(componentOrHandle);
}
function dispatchCommand(handle, command, args) {
    if (__webpack_require__.g.RN$Bridgeless === true) {
        return (__webpack_require__(83644)/* .dispatchCommand */.dispatchCommand)(handle, command, args);
    } else {
        return (__webpack_require__(49098)/* .dispatchCommand */.dispatchCommand)(handle, command, args);
    }
}
function sendAccessibilityEvent(handle, eventType) {
    return (__webpack_require__(49098)/* .sendAccessibilityEvent */.sendAccessibilityEvent)(handle, eventType);
}
function unmountComponentAtNodeAndRemoveContainer(rootTag) {
    var rootTagAsNumber = rootTag;
    (__webpack_require__(49098)/* .unmountComponentAtNodeAndRemoveContainer */.unmountComponentAtNodeAndRemoveContainer)(rootTagAsNumber);
}
function unstable_batchedUpdates(fn, bookkeeping) {
    return (__webpack_require__(49098)/* .unstable_batchedUpdates */.unstable_batchedUpdates)(fn, bookkeeping);
}
function isProfilingRenderer() {
    return Boolean(false);
}
function isChildPublicInstance(parentInstance, childInstance) {
    return (__webpack_require__(49098)/* .isChildPublicInstance */.isChildPublicInstance)(parentInstance, childInstance);
}


}),
85953: (function (__unused_rspack_module, exports, __webpack_require__) {
Object.defineProperty(exports, "__esModule", ({
    value: true
}));
var _export_star = __webpack_require__(2347);
_export_star._(__webpack_require__(29087), exports);


}),
14771: (function (__unused_rspack_module, exports, __webpack_require__) {
"use strict";

__webpack_require__(79489);
var ReactNativePrivateInterface = __webpack_require__(9521), React = __webpack_require__(56728), Scheduler = __webpack_require__(81891);
...
var isArrayImpl = Array.isArray, getFiberCurrentPropsFromNode$1 = null, getInstanceFromNode$1 = null, getNodeFromInstance$1 = null;
...
}, isOrderingDirty$jscomp$inline_233 = !1, pluginName$jscomp$inline_234;
...
var hasOwnProperty = Object.prototype.hasOwnProperty, valueStack = [], index = -1;
...
var emptyContextObject = {}, contextStackCursor$1 = createCursor(emptyContextObject), didPerformWorkStackCursor = createCursor(!1), previousContext = emptyContextObject;
...
function attemptEarlyBailoutIfNoScheduledUpdate(current, workInProgress, renderLanes) {
    switch(workInProgress.tag){
        ...
        case 4:
            ...
            break;
        case 10:
            var context = workInProgress.type._context, nextValue = workInProgress.memoizedProps.value;
    ...
    switch(workInProgress.tag){
        ...
        case 5:
            ...
            if (null !== current && null != workInProgress.stateNode) {
                ...
                var oldProps = current.memoizedProps, requiresClone = doesRequireClone(current, workInProgress);
                if (requiresClone || oldProps !== newProps) {
                    b: {
                        ...
                        if (requiresClone) newProps = null !== oldProps ? cloneNodeWithNewChildrenAndProps(newProps, oldProps) : cloneNodeWithNewChildren(newProps);
                ...
                oldProps = ReactNativePrivateInterface.createPublicInstance(current, renderLanes, workInProgress);
                current = {
                    node: requiresClone,
                    canonical: {
                        nativeTag: current,
        ...
        case 19:
            ...
            if (null === oldProps) {
                if (newProps) cutOffTailIfNeeded(requiresClone, !1);
                    ...
                    null !== requiresClone.tail && now() > workInProgressRootRenderTargetTime && (workInProgress.flags |= 128, newProps = !0, cutOffTailIfNeeded(requiresClone, !1), workInProgress.lanes = 4194304);
                }
            } else {
                ...
                } else 2 * now() - requiresClone.renderingStartTime > workInProgressRootRenderTargetTime && 536870912 !== renderLanes && (workInProgress.flags |= 128, newProps = !0, cutOffTailIfNeeded(requiresClone, !1), workInProgress.lanes = 4194304);
            ...
            if (null !== requiresClone.tail) return workInProgress = requiresClone.tail, requiresClone.rendering = workInProgress, requiresClone.tail = workInProgress.sibling, requiresClone.renderingStartTime = now(), workInProgress.sibling = null, current = suspenseStackCursor.current, push(suspenseStackCursor, newProps ? current & 1 | 2 : current & 1), workInProgress;
            bubbleProperties(workInProgress);
            return null;
        case 22:
        case 23:
...
function commitHookEffectListMount(flags, finishedWork) {
    ...
    if (null !== finishedWork) {
        ...
        do {
            if ((effect.tag & flags) === flags) {
                var create$78 = effect.create, inst = effect.inst;
                create$78 = create$78();
...
function commitRootImpl(root, recoverableErrors, transitions, renderPriorityLevel, spawnedLane) {
    ...
    0 === (finishedWork.subtreeFlags & 10256) && 0 === (finishedWork.flags & 10256) || rootDoesHavePassiveEffects || (rootDoesHavePassiveEffects = !0, scheduleCallback(NormalPriority, function() {
        flushPassiveEffects();
        return null;
    }));
...
beginWork = function beginWork(current, workInProgress, renderLanes) {
    if (null !== current) {
        if (current.memoizedProps !== workInProgress.pendingProps || didPerformWorkStackCursor.current) didReceiveUpdate = !0;
        else {
        ...
        case 10:
            a: {
                ...
                if (null !== hasContext) if (objectIs(hasContext.value, newValue)) {
                    ...
                    } else if (10 === hasContext.tag) newValue = hasContext.type === workInProgress.type ? null : hasContext.child;
                    ...
                    else for(newValue = hasContext; null !== newValue;){
...
var roots = new Map(), devToolsConfig$jscomp$inline_1055 = {
...
85816: (function (__unused_rspack_module, exports, __webpack_require__) {
"use strict";
...
var isArrayImpl = Array.isArray, getFiberCurrentPropsFromNode$1 = null, getInstanceFromNode = null, getNodeFromInstance = null;
function executeDispatch(event, listener, inst) {
    var type = event.type || "unknown-event";
...
}, isOrderingDirty$jscomp$inline_239 = !1, pluginName$jscomp$inline_240;
...
function completeWork(current, workInProgress, renderLanes) {
    ...
    switch(workInProgress.tag){
        ...
        case 5:
            ...
            if (null !== current && null != workInProgress.stateNode) current.memoizedProps !== newProps && (workInProgress.flags |= 4), current.ref !== workInProgress.ref && (workInProgress.flags |= 2097664);
            else {
                if (!newProps) {
                    if (null === workInProgress.stateNode) throw Error("We must have new props for new mounts. This error is likely caused by a bug in React. Please file an issue.");
                    bubbleProperties(workInProgress);
    ...
    if (flags & 2) {
        try {
            ...
            switch(JSCompiler_inline_result.tag){
                ...
                case 3:
                case 4:
                    var parent$82 = JSCompiler_inline_result.stateNode.containerInfo, before$83 = getHostSibling(finishedWork);
...
var roots = new Map(), devToolsConfig$jscomp$inline_1114 = {
...
83644: (function (module, exports, __webpack_require__) {
"use strict";

Object.defineProperty(exports, "__esModule", ({
    value: true
}));
var _ReactNativePrivateInterface = __webpack_require__(9521);
var ReactFabric;
if (false) {} else {
    ReactFabric = __webpack_require__(14771);
}
...
49098: (function (module, __unused_rspack_exports, __webpack_require__) {
"use strict";

var ReactNative;
if (false) {} else {
    ReactNative = __webpack_require__(85816);
}
module.exports = ReactNative;


}),
91452: (function (__unused_rspack_module, exports) {
"use strict";
...
81891: (function (module, __unused_rspack_exports, __webpack_require__) {
"use strict";

if (true) {
    module.exports = __webpack_require__(91452);
} else {}


}),

}]);//# sourceMappingURL=vendors-node_modules_pnpm_react-native_0_74_5__babel_core_7_29_7__babel_preset-env_7_29_7__ba-2cd77e.chunk.bundle.map?platform=ios