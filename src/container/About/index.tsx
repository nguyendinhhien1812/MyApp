...
const TECH_CHIPS = [
  ...
  { label: 'i18n Context', bg: PRIMARY_LIGHT, fg: PRIMARY_DARK },
      ...
      <ScrollView
        ...
        <View style={styles.heroCard}>
          ...
          <View style={styles.appIconWrap}>
            <Icon type="ionicon" name="layers" size={32} color={PRIMARY_DARK} />
          </View>
            ...
            <View style={styles.devInfo}>
              ...
              <View style={styles.devTagRow}>
                <View style={styles.devTag}>
                  <Icon type="ionicon" name="phone-portrait-outline" size={10} color={PRIMARY_DARK} />
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 15, fontWeight: '500', color: '#1a1a1a' },
  ...
  devName: { fontSize: 16, fontWeight: '600', color: '#1a1a1a' },
  devRole: { fontSize: 12, color: '#888', marginTop: 2 },
  ...
  devTagText: { fontSize: 10, fontWeight: '500', color: PRIMARY_DARK },
  ...
  featureText: { flex: 1, fontSize: 13, color: '#333', lineHeight: 20 },
  ...
  footerVersion: { fontSize: 12, color: '#aaa', fontWeight: '500' },
  footerMade: {
    fontSize: 11,
    color: '#ccc',
    textAlign: 'center',
